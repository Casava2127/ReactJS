<!-- https://www.30daysofreact.com/posts/64c58e639338b87c24cafe0d -->
<div align="center">
...
<body>
    ...
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <script type="text/babel">
        // Lấy phần tử gốc từ DOM bằng JS và gán nó cho biến rootElement
        const rootElement = document.querySelector('.root');
        
        // Tạo phần tử JSX -> babel để chuyển JSX về JS thuần
        const element = <h1>Hello, world!</h1>;
        
        // Render phần tử JSX vào DOM
...
1. What is React? - ví dụ như 1 bộ lego, thì mỗi component là 1 mảnh ghép
2. What is a library? như một bộ công cụ có sẵn
3. What is a single page application? -An application which has only one HTML page
Ứng dụng một trang giống như một ứng dụng điện thoại, bạn chỉ cần mở một lần và sau đó có thể tương tác liên tục mà không phải thoát ra và mở lại.
4. What is a component ? 
5. What is the latest version of React?
6. What is DOM?
là một chuẩn được định nghĩa bởi W3C dùng để truy xuất và thao tác trên code HTML hay XML bằng các ngôn ngữ lập trình thông dịch (scripting language) như Javascript.
...
DOM là gì?
DOM (Document Object Model) là một mô hình đối tượng tài liệu đại diện cho cấu trúc nội dung của trang web. Nó cho phép JavaScript thao tác và thay đổi nội dung, cấu trúc và kiểu dáng của trang web.
...
Ví dụ liên tưởng:
DOM giống như một sơ đồ cấu trúc của một tòa nhà, bạn có thể xem và thay đổi từng phòng, từng tầng của tòa nhà.
7. What is React Virtual DOM?
https://viblo.asia/p/hieu-sao-ve-virtual-dom-trong-reactjs-bWrZngDblxw
React Virtual DOM là một phiên bản ảo của DOM thực tế. Khi trạng thái của ứng dụng thay đổi, Virtual DOM sẽ cập nhật và so sánh với DOM thật để xác định sự thay đổi tối thiểu cần thiết, từ đó cải thiện hiệu suất.
...
Ví dụ liên tưởng:
Virtual DOM giống như một bản nháp của một tài liệu, bạn chỉ cần chỉnh sửa trên bản nháp trước khi áp dụng thay đổi vào tài liệu chính, giúp tiết kiệm thời gian và công sức.
...
4. What is JSX? -JSX (JavaScript XML) là một cú pháp mở rộng cho JavaScript, cho phép bạn viết code tương tự HTML trong JavaScript khi làm việc với React
5. What is babel?
Babel là một công cụ biên dịch JavaScript hiện đại, cho phép bạn viết mã JavaScript mới nhất và biên dịch thành JavaScript có thể chạy trên các trình duyệt cũ hơn.

Ví dụ minh họa:
const element = <h1>Hello, world!</h1>;
Nếu bạn viết mã JSX như ví dụ ở trên, Babel sẽ biên dịch nó thành JavaScript chuẩn để trình duyệt hiểu được.
