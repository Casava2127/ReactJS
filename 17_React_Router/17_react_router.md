...
Là thành phần gốc của React Router, quản lý lịch sử điều hướng và cung cấp ngữ cảnh điều hướng cho toàn bộ ứng dụng.

## Route

The Route component allows to navigate -( điều hướng) between components. It is a pathway from one component to another.
...
Định nghĩa một tuyến đường và component được render khi tuyến đường đó khớp với URL hiện tại.
```js
import React, { Component } from 'react'
import ReactDOM from 'react-dom'
...
duy nhất 1 component đc re-render
Chỉ render tuyến đường đầu tiên khớp với URL hiện tại.
